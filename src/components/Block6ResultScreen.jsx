...
function Block6ResultScreen() {
  const navigate = useNavigate()
  const { gameAnswers, calculateBlock6Score } = useGame()
  
  const score = calculateBlock6Score()
  ...
  const imageNames = {
    lapis: 'Lápis',
    relogio: 'Relógio de Pulso'
  }

  const results = [
    {
      question: 'Identifique o Lápis',
      userAnswer: gameAnswers.imagem1 ? imageNames[gameAnswers.imagem1] : 'Não respondido',
      correctAnswer: imageNames[correctAnswers.imagem1],
      isCorrect: gameAnswers.imagem1 === correctAnswers.imagem1
    },
    {
      question: 'Identifique o Relógio de Pulso',
      userAnswer: gameAnswers.imagem2 ? imageNames[gameAnswers.imagem2] : 'Não respondido',
      correctAnswer: imageNames[correctAnswers.imagem2],
      isCorrect: gameAnswers.imagem2 === correctAnswers.imagem2
    }
  ]
...
export default Block6ResultScreen
