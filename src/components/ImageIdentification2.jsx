...
function ImageIdentification2() {
  const navigate = useNavigate()
  const { setAnswer } = useGame()
  const [selectedImage, setSelectedImage] = useState(null)

  const images = [
    { id: 'relogio', emoji: '⌚', name: 'Relógio de Pulso' },
    { id: 'relogio_parede', emoji: '🕐', name: 'Relógio de Parede' },
    { id: 'despertador', emoji: '⏰', name: 'Despertador' },
    { id: 'ampulheta', emoji: '⏳', name: 'Ampulheta' },
    { id: 'cronometro', emoji: '⏱️', name: 'Cronômetro' },
    { id: 'bussola', emoji: '🧭', name: 'Bússola' }
  ]
  ...
  const handleContinue = () => {
    if (selectedImage) {
      setAnswer('imagem2', selectedImage)
      navigate('/resultado-bloco6')
    }
  }
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="text-3xl font-bold text-gray-800">
              Identifique o Relógio de Pulso
            </h2>
          </div>
          
          <p className="text-gray-500 mb-8">
            Selecione a imagem que representa um relógio de pulso
          </p>
...
export default ImageIdentification2
