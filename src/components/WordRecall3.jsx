...
function WordRecall3() {
  ...
  const handleContinue = () => {
    if (selectedWords.length === 3) {
      setAnswer('palavras3', selectedWords)
      navigate('/resultado-bloco3')
    }
  }
